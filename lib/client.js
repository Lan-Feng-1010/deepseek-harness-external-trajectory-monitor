window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = ".D1cM1a_root{--trace-border:color-mix(in srgb, currentColor 14%, transparent);--trace-muted:color-mix(in srgb, currentColor 62%, transparent);height:100%;color:var(--dsw-color-text-primary,#17211b);background:radial-gradient(circle at 12% 0%, #299c6714, transparent 26rem), var(--dsw-color-bg-primary,#fbfcfa);box-sizing:border-box;padding:24px clamp(18px,4vw,56px) 40px;overflow:auto}.D1cM1a_header{justify-content:space-between;align-items:flex-start;gap:28px;max-width:1180px;margin:0 auto 16px;display:flex}.D1cM1a_header h2{letter-spacing:-.025em;margin:5px 0 7px;font-size:clamp(22px,3vw,34px);line-height:1.15}.D1cM1a_header p{color:var(--trace-muted);margin:0;font-size:14px}.D1cM1a_eyebrow{color:#14764a;letter-spacing:.12em;font:700 11px/1.3 ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_exactBadge,.D1cM1a_sequenceBadge{border:1px solid;border-radius:999px;flex:none;padding:9px 12px;font-size:12px;font-weight:700}.D1cM1a_exactBadge{color:#0d7044;background:#e8f7ef;border-color:#addbc4}.D1cM1a_sequenceBadge{color:#76530a;background:#fff7df;border-color:#e8d28e}.D1cM1a_boundary{border:1px solid var(--trace-border);background:color-mix(in srgb, var(--dsw-color-bg-primary,white) 92%, #dcefe4);border-left:3px solid #2b8a60;border-radius:8px;gap:14px;max-width:1150px;margin:0 auto 18px;padding:13px 15px;font-size:13px;display:flex}.D1cM1a_boundary strong{white-space:nowrap}.D1cM1a_boundary span{color:var(--trace-muted)}.D1cM1a_summary{border:1px solid var(--trace-border);background:color-mix(in srgb, var(--dsw-color-bg-primary,white) 96%, currentColor);border-radius:12px;grid-template-columns:repeat(5,minmax(110px,1fr));max-width:1180px;margin:0 auto 18px;display:grid;overflow:hidden}.D1cM1a_summary div{border-right:1px solid var(--trace-border);padding:14px 16px}.D1cM1a_summary div:last-child{border-right:0}.D1cM1a_summary span{color:var(--trace-muted);margin-bottom:3px;font-size:11px;display:block}.D1cM1a_summary strong{font:700 20px/1.2 ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_streams{grid-template-columns:repeat(auto-fit,minmax(210px,1fr));gap:9px;max-width:1180px;margin:-5px auto 18px;display:grid}.D1cM1a_streams>div{border:1px solid var(--trace-border);background:var(--dsw-color-bg-primary,white);border-radius:9px;padding:11px 12px}.D1cM1a_streams>div[data-live=true]{border-color:#67b58d;box-shadow:inset 3px 0 #2b8a60}.D1cM1a_streams>div>div{justify-content:space-between;gap:8px;display:flex}.D1cM1a_streams strong{font-size:12px}.D1cM1a_streams span{color:var(--trace-muted);font-size:10px}.D1cM1a_streams p{margin:6px 0;font:12px ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_streams dl{grid-template-columns:repeat(6,auto);gap:4px;margin:0;font-size:10px;display:grid}.D1cM1a_streams dt{color:var(--trace-muted)}.D1cM1a_streams dd{margin:0 5px 0 0;font-weight:700}.D1cM1a_streams small{color:var(--trace-muted);margin-top:6px;display:block}.D1cM1a_errorCompare{border:1px solid var(--trace-border);background:color-mix(in srgb, var(--dsw-color-bg-primary,white) 96%, #ead7d7);border-radius:12px;max-width:1180px;margin:0 auto 18px;padding:15px}.D1cM1a_comparisonContract{background:color-mix(in srgb, var(--dsw-color-bg-primary,white) 93%, #dcecf3);border-left:3px solid #4d748a;grid-template-columns:235px 1fr;gap:12px;margin-bottom:10px;padding:9px 11px;font-size:11px;display:grid}.D1cM1a_comparisonContract span{color:var(--trace-muted)}.D1cM1a_comparisonTable{border:1px solid var(--trace-border);background:var(--trace-border);border-radius:8px;gap:1px;margin-bottom:15px;display:grid;overflow:hidden}.D1cM1a_comparisonTable>div{background:var(--dsw-color-bg-primary,white);grid-template-columns:1.25fr 1.75fr .65fr .42fr .5fr .5fr .72fr;align-items:center;gap:8px;padding:7px 9px;font-size:9px;display:grid}.D1cM1a_comparisonTable>div[data-head=true]{color:var(--trace-muted);font-weight:700}.D1cM1a_comparisonTable>div[data-focus=true]{box-shadow:inset 3px 0 #d4863c}.D1cM1a_comparisonTable strong{font-size:10px}.D1cM1a_sectionTitle{justify-content:space-between;align-items:flex-end;gap:16px;margin-bottom:11px;display:flex}.D1cM1a_sectionTitle span{color:#a03d3d;letter-spacing:.1em;font:700 9px ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_sectionTitle h3{margin:2px 0 0;font-size:17px}.D1cM1a_sectionTitle p{color:var(--trace-muted);margin:0;font-size:11px}.D1cM1a_errorGrid{grid-template-columns:repeat(3,1fr);gap:9px;display:grid}.D1cM1a_errorGrid article{border:1px solid var(--trace-border);background:var(--dsw-color-bg-primary,white);border-radius:9px;min-width:0;padding:12px}.D1cM1a_errorGrid article[data-focus=true]{border-color:#d4863c;box-shadow:inset 3px 0 #d4863c}.D1cM1a_errorGrid header{justify-content:space-between;gap:8px;display:flex}.D1cM1a_errorGrid header strong,.D1cM1a_errorGrid header span{display:block}.D1cM1a_errorGrid header strong{font-size:12px}.D1cM1a_errorGrid header span{color:var(--trace-muted);margin-top:2px;font:10px ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_errorGrid header b{color:#b33a3a;font:700 18px ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_errorCounts{color:var(--trace-muted);gap:12px;margin:9px 0;font-size:10px;display:flex}.D1cM1a_recoveryLine{color:#6e4c29;margin:-4px 0 8px;font-size:9px}.D1cM1a_errorChips{flex-wrap:wrap;gap:4px;display:flex}.D1cM1a_errorChips code{color:#8f3030;background:#faeeee;border-radius:4px;padding:3px 5px;font-size:9px}.D1cM1a_categoryChips{flex-wrap:wrap;gap:4px;margin-bottom:6px;display:flex}.D1cM1a_categoryChips code{color:#82501e;background:#fff6e9;border:1px solid #d9a973;border-radius:999px;padding:3px 5px;font-size:9px}.D1cM1a_noError{color:#24704b;font-size:11px}.D1cM1a_errorGrid details{margin-top:10px;font-size:10px}.D1cM1a_errorGrid summary{cursor:pointer;color:#9a3434;font-weight:700}.D1cM1a_errorGrid dl{grid-template-columns:76px 1fr;gap:5px 8px;margin:8px 0 0;display:grid}.D1cM1a_errorGrid dt{color:var(--trace-muted)}.D1cM1a_errorGrid dd{word-break:break-word;min-width:0;margin:0}.D1cM1a_implantQueue{border-top:1px solid var(--trace-border);margin-top:13px;padding-top:12px}.D1cM1a_queueTitle{justify-content:space-between;align-items:flex-end;gap:16px;margin-bottom:8px;display:flex}.D1cM1a_queueTitle span{color:#a45b22;letter-spacing:.1em;font:700 9px ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_queueTitle h4{margin:2px 0 0;font-size:15px}.D1cM1a_queueTitle p{color:var(--trace-muted);margin:0;font-size:10px}.D1cM1a_queueList{gap:6px;display:grid}.D1cM1a_queueList details{border:1px solid var(--trace-border);background:var(--dsw-color-bg-primary,white);border-radius:7px;overflow:hidden}.D1cM1a_queueList summary{cursor:pointer;grid-template-columns:28px minmax(140px,.7fr) minmax(140px,1fr) auto;align-items:center;gap:8px;padding:8px 10px;display:grid}.D1cM1a_queueList summary b{color:#a43e3e;font:700 10px ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_queueList summary code{text-overflow:ellipsis;color:#333;white-space:nowrap;font-size:10px;overflow:hidden}.D1cM1a_queueList summary span{color:#96511f;font-size:10px;font-weight:700}.D1cM1a_queueList summary small{color:var(--trace-muted);font:9px ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_queueList dl{border-top:1px solid var(--trace-border);grid-template-columns:105px minmax(0,1fr);gap:5px 10px;margin:0;padding:9px 12px 11px 46px;font-size:10px;display:grid}.D1cM1a_queueList dt{color:var(--trace-muted)}.D1cM1a_queueList dd{word-break:break-word;min-width:0;margin:0}.D1cM1a_queueList dd code{white-space:pre-wrap}.D1cM1a_errorCategory{color:#8e561f;border:1px solid #e3b477;border-radius:999px;padding:2px 6px;font-size:9px}.D1cM1a_workflowNode{color:#355a84;background:#e9eff8;border-radius:4px;padding:2px 6px;font:700 9px ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_controls{z-index:3;background:color-mix(in srgb, var(--dsw-color-bg-primary,#fbfcfa) 94%, transparent);backdrop-filter:blur(10px);align-items:center;gap:12px;max-width:1180px;margin:0 auto 14px;padding:12px 0;display:flex;position:sticky;top:-24px}.D1cM1a_filters{border:1px solid var(--trace-border);background:var(--dsw-color-bg-primary,white);border-radius:9px;gap:5px;padding:4px;display:flex}.D1cM1a_filters button,.D1cM1a_expand{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px}.D1cM1a_filters button{padding:6px 9px;font-size:12px}.D1cM1a_filters button[data-active=true]{color:#fff;background:#1d7650}.D1cM1a_controls input{border:1px solid var(--trace-border);min-width:160px;color:inherit;background:var(--dsw-color-bg-primary,white);border-radius:8px;flex:1;padding:9px 11px}.D1cM1a_visibleCount{color:var(--trace-muted);white-space:nowrap;font:12px ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_timeline{max-width:1180px;margin:0 auto}.D1cM1a_event{grid-template-columns:24px 1fr;min-width:0;display:grid}.D1cM1a_rail{justify-content:center;display:flex;position:relative}.D1cM1a_rail:after{content:\"\";background:var(--trace-border);width:1px;position:absolute;top:22px;bottom:-12px}.D1cM1a_event:last-child .D1cM1a_rail:after{display:none}.D1cM1a_dot,.D1cM1a_toolDot,.D1cM1a_errorDot,.D1cM1a_markerDot{z-index:1;border:3px solid var(--dsw-color-bg-primary,#fbfcfa);width:9px;height:9px;box-shadow:0 0 0 1px var(--trace-border);border-radius:50%;margin-top:19px;position:relative}.D1cM1a_dot{background:#29825b}.D1cM1a_toolDot{background:#336fb0}.D1cM1a_errorDot{background:#c94242}.D1cM1a_markerDot{background:#9b7a3b}.D1cM1a_eventBody{border:1px solid var(--trace-border);background:color-mix(in srgb, var(--dsw-color-bg-primary,white) 97%, currentColor);border-radius:10px;min-width:0;margin:0 0 12px 7px;padding:14px 16px}.D1cM1a_publicEvent .D1cM1a_eventBody{border-left:3px solid #38956c}.D1cM1a_markerEvent .D1cM1a_eventBody{background:color-mix(in srgb, var(--dsw-color-bg-primary,white) 95%, #e6d6b5);border-style:dashed}.D1cM1a_toolEvent[data-tool-status=error] .D1cM1a_eventBody{border-left:3px solid #c94242}.D1cM1a_eventTopline{flex-wrap:wrap;align-items:center;gap:9px;display:flex}.D1cM1a_kind,.D1cM1a_toolName{font-size:13px;font-weight:750}.D1cM1a_streamBadge,.D1cM1a_streamLive{border:1px solid var(--trace-border);color:var(--trace-muted);border-radius:999px;padding:2px 6px;font-size:9px}.D1cM1a_streamLive{color:#12673f;background:#e9f8ef;border-color:#8bc9a8}.D1cM1a_toolName{color:#215f9a;font:750 14px ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_time,.D1cM1a_source{color:var(--trace-muted);font:11px ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_source{margin-left:auto}.D1cM1a_statusOk,.D1cM1a_statusError{border-radius:999px;padding:2px 6px;font-size:10px;font-weight:700}.D1cM1a_statusOk{color:#12673f;background:#e4f5eb}.D1cM1a_statusError{color:#a72e2e;background:#fde8e8}.D1cM1a_prose,.D1cM1a_markerCopy{white-space:pre-wrap;margin:10px 0 0;font-size:13px;line-height:1.6}.D1cM1a_markerCopy{color:var(--trace-muted)}.D1cM1a_transition{color:#315f8b;margin:9px 0 8px;font:650 12px ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_metrics{color:var(--trace-muted);flex-wrap:wrap;gap:8px 18px;font-size:11px;display:flex}.D1cM1a_metrics strong{color:inherit;font-family:ui-monospace,SFMono-Regular,Consolas,monospace}.D1cM1a_context{background:color-mix(in srgb, var(--dsw-color-bg-primary,white) 91%, #cfe9db);border-radius:7px;margin-top:10px;padding:9px 11px;font-size:12px;line-height:1.5}.D1cM1a_context span,.D1cM1a_previewGrid span{color:var(--trace-muted);text-transform:uppercase;letter-spacing:.05em;margin-bottom:3px;font-size:10px;font-weight:700;display:block}.D1cM1a_previewGrid{grid-template-columns:1fr 1fr;gap:9px;margin-top:10px;display:grid}.D1cM1a_previewGrid>div{border:1px solid var(--trace-border);border-radius:7px;min-width:0;padding:8px 10px}.D1cM1a_previewGrid code{color:inherit;white-space:nowrap;text-overflow:ellipsis;font-size:11px;display:block;overflow:hidden}.D1cM1a_expand{color:#1d7650;margin-top:9px;padding:5px 0;font-size:11px;font-weight:700}.D1cM1a_fullGrid{grid-template-columns:1fr 1fr;gap:10px;margin-top:8px;display:grid}.D1cM1a_fullGrid section{min-width:0}.D1cM1a_fullGrid h4{margin:0 0 5px;font-size:11px}.D1cM1a_fullGrid pre{border:1px solid var(--trace-border);background:color-mix(in srgb, var(--dsw-color-bg-primary,#fff) 92%, #8aa59a);white-space:pre-wrap;word-break:break-word;border-radius:7px;max-height:380px;margin:0;padding:10px;font-size:10px;line-height:1.45;overflow:auto}.D1cM1a_footer{max-width:1150px;color:var(--trace-muted);margin:16px auto 0;padding-left:31px;font-size:11px}.D1cM1a_footer summary{cursor:pointer;font-weight:700}.D1cM1a_footer code,.D1cM1a_footer span{word-break:break-all;margin-top:5px;display:block}.D1cM1a_centerState{height:100%;color:var(--dsw-color-text-secondary,#66736b);place-items:center;display:grid}@media (width<=800px){.D1cM1a_root{padding:18px 12px 28px}.D1cM1a_header,.D1cM1a_boundary,.D1cM1a_controls{flex-direction:column;align-items:stretch}.D1cM1a_summary{grid-template-columns:repeat(2,1fr)}.D1cM1a_summary div{border-bottom:1px solid var(--trace-border)}.D1cM1a_previewGrid,.D1cM1a_fullGrid,.D1cM1a_errorGrid,.D1cM1a_comparisonContract{grid-template-columns:1fr}.D1cM1a_comparisonTable>div{grid-template-columns:1fr 1fr}.D1cM1a_comparisonTable>div span:last-child{grid-column:2}.D1cM1a_queueTitle{flex-direction:column;align-items:flex-start;gap:4px}.D1cM1a_queueList summary{grid-template-columns:28px 1fr}.D1cM1a_queueList summary small{grid-column:2}.D1cM1a_queueList dl{grid-template-columns:1fr;padding-left:12px}.D1cM1a_source{margin-left:0}}";
		...
		var observable_reasoning_module_css_default = {
			"queueList": "D1cM1a_queueList",
			"root": "D1cM1a_root",
			"categoryChips": "D1cM1a_categoryChips",
			"eyebrow": "D1cM1a_eyebrow",
			"markerEvent": "D1cM1a_markerEvent",
			"toolEvent": "D1cM1a_toolEvent",
			"statusOk": "D1cM1a_statusOk",
			"implantQueue": "D1cM1a_implantQueue",
			"expand": "D1cM1a_expand",
			"statusError": "D1cM1a_statusError",
			"comparisonContract": "D1cM1a_comparisonContract",
			"queueTitle": "D1cM1a_queueTitle",
			"toolDot": "D1cM1a_toolDot",
			"toolName": "D1cM1a_toolName",
			"summary": "D1cM1a_summary",
			"recoveryLine": "D1cM1a_recoveryLine",
			"exactBadge": "D1cM1a_exactBadge",
			"controls": "D1cM1a_controls",
			"publicEvent": "D1cM1a_publicEvent",
			"kind": "D1cM1a_kind",
			"context": "D1cM1a_context",
			"prose": "D1cM1a_prose",
			"boundary": "D1cM1a_boundary",
			"sectionTitle": "D1cM1a_sectionTitle",
			"errorChips": "D1cM1a_errorChips",
			"visibleCount": "D1cM1a_visibleCount",
			"sequenceBadge": "D1cM1a_sequenceBadge",
			"streamBadge": "D1cM1a_streamBadge",
			"event": "D1cM1a_event",
			"markerCopy": "D1cM1a_markerCopy",
			"comparisonTable": "D1cM1a_comparisonTable",
			"noError": "D1cM1a_noError",
			"streams": "D1cM1a_streams",
			"eventTopline": "D1cM1a_eventTopline",
			"transition": "D1cM1a_transition",
			"errorCompare": "D1cM1a_errorCompare",
			"source": "D1cM1a_source",
			"previewGrid": "D1cM1a_previewGrid",
			"errorGrid": "D1cM1a_errorGrid",
			"errorCounts": "D1cM1a_errorCounts",
			"errorDot": "D1cM1a_errorDot",
			"rail": "D1cM1a_rail",
			"timeline": "D1cM1a_timeline",
			"footer": "D1cM1a_footer",
			"metrics": "D1cM1a_metrics",
			"workflowNode": "D1cM1a_workflowNode",
			"streamLive": "D1cM1a_streamLive",
			"markerDot": "D1cM1a_markerDot",
			"eventBody": "D1cM1a_eventBody",
			"time": "D1cM1a_time",
			"fullGrid": "D1cM1a_fullGrid",
			"header": "D1cM1a_header",
			"centerState": "D1cM1a_centerState",
			"dot": "D1cM1a_dot",
			"errorCategory": "D1cM1a_errorCategory",
			"filters": "D1cM1a_filters"
		};
		//#endregion
